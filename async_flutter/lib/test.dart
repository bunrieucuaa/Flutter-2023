...
class _ArticleListState extends State<ArticleList> {
  ...
  void initState() {
    ...
    futureArticles = getArticles(
        widget.category, widget.searchQuery); // Pass searchQuery to getArticles
  }
  ...
  Future<List<Article>> getArticles(String category, String searchQuery) async {
    var url =
        'https://newsapi.org/v2/top-headlines?country=us&category=$category&apiKey=0efae46792d94f8998baf86c5f2ceb5f';
